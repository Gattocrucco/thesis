...
mentioned in \autoref{sec:expval}, or less likely afterpulses.
...
that assuming degradation it can diverge if too high initially, cite
\cite[sec.~2.2, p.~8]{gola2019} to say that 0.5 may be the maximum acceptable,
and cite the Yellow Book to say the maximum accepted by the specs. See logbook
May 17.}
...
\marginpar{Look if the VETO electronics is explained in \cite{aalseth2019}.}
