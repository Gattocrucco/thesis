...
spectrum makes a large difference at low SNR.

\begin{figure}
    Temporal resolution comparison figure. Make it tall so that you can see the
    low resolution cc filters well together with the expmovavg.
    \caption{}
    \label{fig:rescomp}
\end{figure}
...
\section{Effect of waveform truncation}
...
between the digitizers and the FEPs happens to be a bottleneck. Thus 
