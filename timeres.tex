...
\marginpar{Actually, it is improving, this must be a bug.}

\begin{table}
    \centering
    \begin{tabular}{c|cccc}
               & \SI{1}{GSa/s} & \SI{125}{MSa/s} & \SI{62.5}{MSa/s} & \SI{31.2}{MSa/s} \\ \hline
        Proto0 &               &            3.64 &              3.9 &             4.57 \\
          LNGS &          6.26 &            6.34 &             7.02 &             8.34 \\
         White &          4.68 &            4.76 &             5.05 &             5.97
    \end{tabular}
    
    \caption{Ratio of SNR after over before filtering, corrected for
    downsampled noise variance reduction.}
