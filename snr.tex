...
figure~\ref{fig:signals} for an example. \marginpar{Bibliography for the SiPM.}
...
figure~\ref{fig:lngs}. \marginpar{Bibliography for the LNGS data.}
...
\url{http://ds50tb.lngs.infn.it:2180/SiPM/Tiles/FBK/NUV/MB2-LF-3x/NUV-LF_3x_57/}. We used the file \verb'nuvhd_lf_3x_tile57_77K_64V_6VoV_1.wav'.
\marginpar{Slot 8 probably is just a Proto0 name, should mention it later.}
\marginpar{What are these ``tiles''?}

\begin{figure}
    \centering\includegraphics[width=\textwidth]{PDMadcCh}
...
\begin{figure}
    ...
    \includegraphics[width=1.00\textwidth]{figautocorrlngs}
...
\begin{figure}
    \hspace{0.00\textwidth}
    \includegraphics[width=1.00\textwidth]{figtemplate}
...
\begin{figure}
    \hspace{0.00\textwidth}
    \includegraphics[width=1.00\textwidth]{figfilters}
    
    \caption{An event from the LNGS test data filtered with the three filters
    used. The number of averaged samples in the moving average filter, the
    scale of the autoregressive filter, and the length of the template of
    the cross-correlation filter are all 1024 samples (at \SI1{GSa/s}).}
...
\begin{figure}
    ...
    \includegraphics[width=1.50\textwidth]{figfiltersample}
...
\begin{figure}
    \hspace{0.00\textwidth}
    \includegraphics[width=1.00\textwidth]{figfingerplot}
...
\begin{figure}
    ...
    \includegraphics[width=1.51\textwidth]{figsnrplot}
...
\begin{figure}
    \hspace{0.00\textwidth}
    \includegraphics[width=1.00\textwidth]{figsnrmaxplot}
...
\begin{figure}
    ...
    \includegraphics[width=1.55\textwidth]{figchangebs}
...
figure~\ref{fig:spectra}. \marginpar{Source and details of the Proto0 noise
data.}

\begin{figure}
    \hspace{-0.28\textwidth}
    \includegraphics[width=1.56\textwidth]{figspectra}
...
\begin{figure}
    \hspace{0.00\textwidth}
    \includegraphics[width=1.00\textwidth]{figtemplsp}
