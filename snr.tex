...
\marginpar{Bibliography for the LNGS data.}
...
\marginpar{Add the autocorrelation of the Proto0 noise to the plot. And: $R$ is
not Toeplitz, it can be seen as the central submatrix of a Toeplitz matrix.}
